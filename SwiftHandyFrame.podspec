...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is SwiftHandyFrame
                   DESC

  s.homepage     = "https://github.com/casatwy/SwiftHandyFrame"
  ...
  s.source       = { :git => "https://github.com/casatwy/SwiftHandyFrame.git", :tag => s.version.to_s }
  ...
  s.source_files  = "SwiftHandyFrame/SwiftHandyFrame/**/*.{h,m,swift}"
